...
export default function SearchBar({
  ...
  useEffect(() => {
    if (fetchJobs) {
      ...
      setSearchParamObject((prevState) => ({
        ...prevState,
        query: query,
        jobSearchTerm: jobSearchTerm || false,
        locationSearchTerm: locationSearchTerm || false,
      }));
    }
  }, [fetchJobs, jobSearchTerm, locationSearchTerm]);
  ...
  return (
    <>
      ...
      {/* Render search param buttons only on /jobs route */}
      {location.pathname === "/jobs" && (
        <div
            ...
            >
              ...
              <label>
                <input
                  ...
                  onChange={handleCheckBoxChange}
                  checked={
                    searchParamObject.employment_types?.includes(
                      "CONTRACTOR"
                    ) || false
                  }
                />
